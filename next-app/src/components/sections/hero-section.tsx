    ...
    <div className="w-full flex flex-col items-center relative">
      ...
      <div className="bg-white/20 backdrop-blur-sm w-full py-4 px-6 rounded-lg flex flex-col items-center justify-center gap-6 text-center lg:absolute lg:bottom-[10%] lg:left-auto lg:w-[90%]">
        <h1
          className={cn(
            kodchasanFont,
            "text-foreground text-xl lg:text-4xl font-black"
          )}
        >
        ...
        <p className="text-foreground text-sm text-justify lg:text-lg font-semibold">
          Avec{" "}
          <span className="text-lg lg:text-xl font-extrabold bg-clip-text text-transparent bg-primary-gradient drop-shadow">
            EduCraft
          </span>
          , créez des leçons sur mesure et des exercices interactifs adaptés aux
          besoins de vos enfants. Suivez facilement leur progression et
